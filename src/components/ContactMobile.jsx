...
export default function ContactMobile() {
  ...
  return (
    <section
      id="contact"
      className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-6 py-20 gap-10"
    >
      {/* Title */}
      <div className="w-full flex flex-col items-center text-center">
        <h2 className="text-5xl font-extrabold flex flex-col">
          <span className="text-white text-[60px] sm:text-[80px] drop-shadow-[0_1px_10px_cyan]">Contact</span>
          <span className="text-cyan-400 text-[50px] sm:text-[70px] pl-2 sm:pl-8 decoration-white">⎯⎯ Us</span>
        </h2>
      </div>
      ...
      <div className="w-full flex justify-center">
        <p className="text-white/70 max-w-sm text-center">
